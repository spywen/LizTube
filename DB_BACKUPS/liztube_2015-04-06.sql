...
# Temps de génération: 2015-04-06 16:45:49 +0000
# ************************************************************
...
CREATE TABLE `video` (
  ...
  `videorankasmostrecent` bigint(20) NOT NULL,
  `videorankasmostshared` bigint(20) NOT NULL,
  PRIMARY KEY (`keyid`),
...
INSERT INTO `video` (`keyid`, `description`, `ispublic`, `ispubliclink`, `title`, `user`, `creationdate`, `videorankasmostviewed`, `videorankasmostrecent`, `videorankasmostshared`)
VALUES
	('3ef39e77-8c2c-4afb-8ad7-d96958536c0f','description',00000001,00000000,'title',1,'2015-04-04 18:45:33',2,1,0),
	('dbc3f06e-1fa2-4d00-ad6a-6cf2b50e3581','description',00000001,00000000,'title',2,'2015-04-03 18:45:45',1,2,0),
	('dbc3f06e-1fa2-4d00-ad6a-6cf2b50e3582','desc\n',00000000,00000000,'titel',2,'2015-04-02 18:45:45',3,3,0);
