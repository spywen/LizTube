...
@TestPropertySource("/application.testing.rates.properties")
public class SearchForVideoBusinessHomeSuggestionAnotherRatesTests {
    ...
    public void should_return_videos_ordered_by_home_suggestion(){
        ...
        assertThat(videosFound.getVideos().get(1).getKey()).isEqualTo("a");
        assertThat(videosFound.getVideos().get(2).getKey()).isEqualTo("b");
        assertThat(videosFound.getVideos().get(3).getKey()).isEqualTo("d");
    }
